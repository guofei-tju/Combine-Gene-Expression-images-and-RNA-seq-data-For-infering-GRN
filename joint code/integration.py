...
class edges_set:
    ...
    def F1_calculating(self):
        ...
        # print('FN', fn_total)
        # print('TN', tn_total)
        return 2 * float(tp_total) / float(2 * tp_total + fp_total + fn_total), fp_total, tp_total, fn_total, tn_total
...
def acc_and_f1(predict_list):
    ...
    # print('accuracy: ',acc)
    f1, FP, TP, FN, TN = gene_pairs.F1_calculating()
    # print('f1: ',f1)

    return acc, f1, gene_pairs, FP, TP, FN, TN
