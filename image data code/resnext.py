...
def ResNext(input_shape=None, depth=29, cardinality=8, width=64, weight_decay=5e-4,
    ...
    x = conv2d_bn(img_input, 64, kernel_size=7, strides=2, layer_name='first_conv')
    x = MaxPool2D(pool_size=(3, 3), strides=2, padding='same', name='pool1')(x)
    x = __create_res_next(classes, x, include_top, depth, cardinality, width,
