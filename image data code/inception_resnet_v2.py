...
def InceptionResNetV2(include_top=True,
    ...
    x = layers.Concatenate(axis=-1, name='mixed_1')([branch_0, branch_1])
    ...
    x = layers.Concatenate(axis=-1, name='mixed_2')([branch_0, branch_1])
    branch_0 = conv2d_bn(x, 192, 3, strides=2, padding='valid')
    branch_1 = layers.MaxPooling2D(3, strides=2)(x)
    x = layers.Concatenate(axis=-1, name='mixed_3')([branch_0, branch_1])
